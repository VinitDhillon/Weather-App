...
fun WetherDetails(data: WetherModel) {
        ...
        Card() {
            Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                   ...
                   WetherKeyVal("Humidity",data.current.humidity)
                    WetherKeyVal("Wind Speed",data.current.wind_kph)
                ...
                Row(
                    ...
                    WetherKeyVal("Chance of Rain",data.current.chance_of_rain)
                    WetherKeyVal("Feels Like","${data.current.feelslike_c}°c")
                ...
                Row(
                    ...
                    WetherKeyVal("Pressure",data.current.pressure_in)
                    WetherKeyVal("Cloud",data.current.cloud)
    ...
    @Composable
    fun WetherKeyVal(key: String,value: String){
